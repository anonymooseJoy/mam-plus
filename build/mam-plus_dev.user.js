...
class ShoutMenuUserActions {
    ...
    _getStoredUsers(settingKey) {
        const storedValue = GM_getValue(`${settingKey}_val`);
        if (!storedValue) {
            return [];
        }
        return Util.csvToArray(storedValue).filter((entry) => entry !== '');
    }
    _setStoredUsers(settingKey, values) {
        GM_setValue(settingKey, values.length > 0);
        if (values.length > 0) {
            GM_setValue(`${settingKey}_val`, values.join(', '));
        }
    }
    _addUser(settingKey, userID) {
        ...
        const openSettingsInput = document.getElementById(settingKey);
    ...
    _init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            sbfDiv.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
                ...
                const popupUser = popupMenu.firstElementChild;
                const userID = popupUser === null || popupUser === void 0 ? void 0 : popupUser.getAttribute('data-uid');
            ...
            shoutbox === null || shoutbox === void 0 ? void 0 : shoutbox.addEventListener('click', (e) => {
                const target = e.target;
                const popupUser = target.closest('#sbMenuMain > ul');
                const userID = popupUser === null || popupUser === void 0 ? void 0 : popupUser.getAttribute('data-uid');
                if (!popupUser || !userID) {
                    return;
                }
                if (target.id === 'mp_sbEmphasize') {
                    ...
                    this._showStatus(added
                        ? `Added user ${userID} to the emphasize list`
                        : `User ${userID} is already emphasized`, added);
                }
                    ...
                    this._showStatus(added
                        ...
                        : `User ${userID} is already blocked`, added);
                }
            });
        });
    }
